  ...
  return (
    <div className="w-full bg-white dark:bg-gray-950">
      <footer
        ...
        <div className="w-full bg-white dark:bg-gray-950 p-4 text-center grid text-black  dark:text-white">
        ...
        <div className="w-full font-mono bg-white dark:bg-gray-950 p-4 text-center text-black  dark:text-white">
          © 2024 Copyright:
